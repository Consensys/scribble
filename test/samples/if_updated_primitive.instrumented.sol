...
contract Base {
    ...
    function Base_x_inline_initializer() internal {
        unchecked {
            if (!(x >= 1)) {
                emit __ScribbleUtilsLib__139.AssertionFailed("01352:064:00 0: ");
                assert(false);
            }
        }
    }
    ...
    function Base_a_inline_initializer() internal {
        unchecked {
            if (!(uint160(a) >= 1)) {
                emit __ScribbleUtilsLib__139.AssertionFailed("01606:064:00 3: ");
                assert(false);
            }
        }
    }
    ...
    function Base_x_uint256_assign(uint256 ARG0) internal returns (uint256 RET0) {
        ...
        unchecked {
            if (!(x >= 1)) {
                emit __ScribbleUtilsLib__139.AssertionFailed("01918:064:00 0: ");
                assert(false);
            }
        }
    }
    ...
    function Base_y_uint256_assign(uint256 ARG1) internal returns (uint256 RET1) {
        ...
        unchecked {
            if (!(y >= _v.old_0)) {
                emit __ScribbleUtilsLib__139.AssertionFailed("02318:064:00 1: ");
                assert(false);
            }
        }
    }
    ...
    function Base_a_address_assign(address ARG2) internal returns (address RET2) {
        ...
        unchecked {
            if (!(uint160(a) >= 1)) {
                emit __ScribbleUtilsLib__139.AssertionFailed("02639:064:00 3: ");
                assert(false);
            }
        }
    }
    ...
    function Base_x_inc_postfix() internal returns (uint256 RET3) {
        ...
        unchecked {
            if (!(x >= 1)) {
                emit __ScribbleUtilsLib__139.AssertionFailed("02931:064:00 0: ");
                assert(false);
            }
        }
    }
    ...
    function Base_y_inc_postfix() internal returns (uint256 RET4) {
        ...
        unchecked {
            if (!(y >= _v.old_1)) {
                emit __ScribbleUtilsLib__139.AssertionFailed("03311:064:00 1: ");
                assert(false);
            }
        }
    }
    ...
    function Base_t_delete() internal {
        ...
        unchecked {
            if (!(t == 0)) {
                emit __ScribbleUtilsLib__139.AssertionFailed("03562:064:00 2: ");
                assert(false);
            }
        }
    }
    ...
    function Base_x_inc_prefix() internal returns (uint256 RET5) {
        ...
        unchecked {
            if (!(x >= 1)) {
                emit __ScribbleUtilsLib__139.AssertionFailed("03853:064:00 0: ");
                assert(false);
            }
        }
    }
