...
contract Foo {
    ...
    /// checks for unchecked_sum() @custom:scribble #if_succeeds unchecked_sum(a) > 10 && unchecked_sum(a) < 20;
    ...
    /// checks for unchecked_sum() @custom:scribble #if_succeeds unchecked_sum(b) > -10 && unchecked_sum(b) < 10;
    ...
    /// checks for unchecked_sum() @custom:scribble #if_succeeds unchecked_sum(c) > -10 && unchecked_sum(c) < 10;
