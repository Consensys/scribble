...
contract Foo {
    ...
    function setA(uint k, uint v) public {
        ...
        unchecked {
            if (!((a.sum > 10) && (a.sum < 20))) {
                emit __ScribbleUtilsLib__227.AssertionFailed("00951:064:00 0: ");
                assert(false);
            }
        }
    }
    ...
    function incA(uint k) public {
        ...
        unchecked {
            if (!((a.sum > 10) && (a.sum < 20))) {
                emit __ScribbleUtilsLib__227.AssertionFailed("01342:064:00 1: ");
                assert(false);
            }
        }
    }
    ...
    function decA(uint k) public {
        ...
        unchecked {
            if (!((a.sum > 10) && (a.sum < 20))) {
                emit __ScribbleUtilsLib__227.AssertionFailed("01722:064:00 2: ");
                assert(false);
            }
        }
    }
    ...
    function setB(uint k, int8 v) public {
        ...
        unchecked {
            if (!(b.sum > 128)) {
                emit __ScribbleUtilsLib__227.AssertionFailed("02096:064:00 3: ");
                assert(false);
            }
        }
    }
    ...
    function decB(uint k) public {
        ...
        unchecked {
            if (!(b.sum > 128)) {
                emit __ScribbleUtilsLib__227.AssertionFailed("02467:064:00 4: ");
                assert(false);
            }
        }
    }
    ...
    function setC(string memory k1, uint k2, int16 v) public {
        ...
        unchecked {
            ...
            if (!(_v.forall_0)) {
                emit __ScribbleUtilsLib__227.AssertionFailed("04017:064:00 5: ");
                assert(false);
            }
        }
    }
    ...
    function decC(string memory k1, uint k2) public {
        ...
        unchecked {
            ...
            if (!(_v.forall_1)) {
                emit __ScribbleUtilsLib__227.AssertionFailed("04795:064:00 6: ");
                assert(false);
            }
        }
    }
    ...
    function incC(string memory k1, uint k2) public {
        ...
        unchecked {
            ...
            if (!(_v.forall_2)) {
                emit __ScribbleUtilsLib__227.AssertionFailed("05600:064:00 7: ");
                assert(false);
            }
        }
    }
