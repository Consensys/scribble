...
contract Foo {
    ...
    function setA(uint k, uint v) public {
        ...
        unchecked {
            if (!((a.sum > 10) && (a.sum < 20))) {
                __ScribbleUtilsLib__227.assertionFailed("0: ");
                assert(false);
            }
        }
    }
    ...
    function incA(uint k) public {
        ...
        unchecked {
            if (!((a.sum > 10) && (a.sum < 20))) {
                __ScribbleUtilsLib__227.assertionFailed("1: ");
                assert(false);
            }
        }
    }
    ...
    function decA(uint k) public {
        ...
        unchecked {
            if (!((a.sum > 10) && (a.sum < 20))) {
                __ScribbleUtilsLib__227.assertionFailed("2: ");
                assert(false);
            }
        }
    }
    ...
    function setB(uint k, int8 v) public {
        ...
        unchecked {
            if (!(b.sum > 128)) {
                __ScribbleUtilsLib__227.assertionFailed("3: ");
                assert(false);
            }
        }
    }
    ...
    function decB(uint k) public {
        ...
        unchecked {
            if (!(b.sum > 128)) {
                __ScribbleUtilsLib__227.assertionFailed("4: ");
                assert(false);
            }
        }
    }
    ...
    function setC(string memory k1, uint k2, int16 v) public {
        ...
        unchecked {
            ...
            if (!(_v.forall_0)) {
                __ScribbleUtilsLib__227.assertionFailed("5: ");
                assert(false);
            }
        }
    }
    ...
    function decC(string memory k1, uint k2) public {
        ...
        unchecked {
            ...
            if (!(_v.forall_1)) {
                __ScribbleUtilsLib__227.assertionFailed("6: ");
                assert(false);
            }
        }
    }
    ...
    function incC(string memory k1, uint k2) public {
        ...
        unchecked {
            ...
            if (!(_v.forall_2)) {
                __ScribbleUtilsLib__227.assertionFailed("7: ");
                assert(false);
            }
        }
    }
