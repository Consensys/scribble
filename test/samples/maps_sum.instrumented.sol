...
contract Foo {
    ...
    function setA(uint k, uint v) public {
        ...
        unchecked {
            if (!((a.sum > 10) && (a.sum < 20))) {
                emit __ScribbleUtilsLib__227.AssertionFailed("0: ");
                assert(false);
            }
        }
    }
    ...
    function incA(uint k) public {
        ...
        unchecked {
            if (!((a.sum > 10) && (a.sum < 20))) {
                emit __ScribbleUtilsLib__227.AssertionFailed("1: ");
                assert(false);
            }
        }
    }
    ...
    function decA(uint k) public {
        ...
        unchecked {
            if (!((a.sum > 10) && (a.sum < 20))) {
                emit __ScribbleUtilsLib__227.AssertionFailed("2: ");
                assert(false);
            }
        }
    }
    ...
    function setB(uint k, int8 v) public {
        ...
        unchecked {
            if (!(b.sum > 128)) {
                emit __ScribbleUtilsLib__227.AssertionFailed("3: ");
                assert(false);
            }
        }
    }
    ...
    function decB(uint k) public {
        ...
        unchecked {
            if (!(b.sum > 128)) {
                emit __ScribbleUtilsLib__227.AssertionFailed("4: ");
                assert(false);
            }
        }
    }
    ...
    function setC(string memory k1, uint k2, int16 v) public {
        ...
        unchecked {
            ...
            if (!(_v.forall_0)) {
                emit __ScribbleUtilsLib__227.AssertionFailed("5: ");
                assert(false);
            }
        }
    }
    ...
    function decC(string memory k1, uint k2) public {
        ...
        unchecked {
            ...
            if (!(_v.forall_1)) {
                emit __ScribbleUtilsLib__227.AssertionFailed("6: ");
                assert(false);
            }
        }
    }
    ...
    function incC(string memory k1, uint k2) public {
        ...
        unchecked {
            ...
            if (!(_v.forall_2)) {
                emit __ScribbleUtilsLib__227.AssertionFailed("7: ");
                assert(false);
            }
        }
    }
