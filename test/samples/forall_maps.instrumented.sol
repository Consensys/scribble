...
contract Foo {
    ...
    function setA(uint key, uint val) public {
        ...
        unchecked {
            ...
            if (!(_v.forall_0)) {
                __ScribbleUtilsLib__326.assertionFailed("0: ");
                assert(false);
            }
        }
    }
    ...
    function decA(uint key) public {
        ...
        unchecked {
            ...
            if (!(_v.forall_1)) {
                __ScribbleUtilsLib__326.assertionFailed("1: ");
                assert(false);
            }
        }
    }
    ...
    function setC(string memory s, int16 v) public {
        ...
        unchecked {
            ...
            if (!(_v.forall_2)) {
                __ScribbleUtilsLib__326.assertionFailed("2: ");
                assert(false);
            }
        }
    }
    ...
    function setD(string memory s, uint8 k, int8 v) public {
        ...
        unchecked {
            ...
            if (!(_v.forall_3)) {
                __ScribbleUtilsLib__326.assertionFailed("3: ");
                assert(false);
            }
        }
    }
    ...
    function setE(uint k, uint[] memory v) public {
        ...
        unchecked {
            ...
            if (!(_v.forall_5)) {
                __ScribbleUtilsLib__326.assertionFailed("4: ");
                assert(false);
            }
        }
    }
    ...
    function setF(uint i, uint j, uint v) public {
        ...
        unchecked {
            ...
            if (!(_v.forall_6)) {
                __ScribbleUtilsLib__326.assertionFailed("5: ");
                assert(false);
            }
        }
    }
    ...
    function setG(uint i, uint j, uint v) public {
        ...
        unchecked {
            ...
            if (!(_v.forall_7)) {
                __ScribbleUtilsLib__326.assertionFailed("6: ");
                assert(false);
            }
        }
    }
    ...
    function setH(string memory s, uint8 k, int8 v) public {
        ...
        unchecked {
            ...
            if (!(_v.forall_8)) {
                __ScribbleUtilsLib__326.assertionFailed("7: ");
                assert(false);
            }
        }
    }
    ...
    function setI(string memory s, uint8 k, int8 v) public {
        ...
        unchecked {
            ...
            if (!(_v.forall_9)) {
                __ScribbleUtilsLib__326.assertionFailed("8: ");
                assert(false);
            }
        }
    }
    ...
    function setJ(uint saI, string memory x, uint v) public {
        ...
        unchecked {
            ...
            if (!(_v.forall_10)) {
                __ScribbleUtilsLib__326.assertionFailed("9: ");
                assert(false);
            }
        }
    }
    ...
    function setJ2(uint saI, string memory x, uint v) public {
        ...
        unchecked {
            ...
            if (!(_v.forall_11)) {
                __ScribbleUtilsLib__326.assertionFailed("10: ");
                assert(false);
            }
        }
    }
    ...
    function setK1(uint i, uint v) public {
        ...
        unchecked {
            if (!(_v.old_0)) {
                __ScribbleUtilsLib__326.assertionFailed("11: ");
                assert(false);
            }
        }
    }
