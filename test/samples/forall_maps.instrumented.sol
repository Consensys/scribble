...
contract Foo {
    ...
    function setA(uint key, uint val) public {
        ...
        unchecked {
            ...
            if (!(_v.forall_0)) {
                emit __ScribbleUtilsLib__326.AssertionFailed("0: ");
                assert(false);
            }
        }
    }
    ...
    function decA(uint key) public {
        ...
        unchecked {
            ...
            if (!(_v.forall_1)) {
                emit __ScribbleUtilsLib__326.AssertionFailed("1: ");
                assert(false);
            }
        }
    }
    ...
    function setC(string memory s, int16 v) public {
        ...
        unchecked {
            ...
            if (!(_v.forall_2)) {
                emit __ScribbleUtilsLib__326.AssertionFailed("2: ");
                assert(false);
            }
        }
    }
    ...
    function setD(string memory s, uint8 k, int8 v) public {
        ...
        unchecked {
            ...
            if (!(_v.forall_3)) {
                emit __ScribbleUtilsLib__326.AssertionFailed("3: ");
                assert(false);
            }
        }
    }
    ...
    function setE(uint k, uint[] memory v) public {
        ...
        unchecked {
            ...
            if (!(_v.forall_5)) {
                emit __ScribbleUtilsLib__326.AssertionFailed("4: ");
                assert(false);
            }
        }
    }
    ...
    function setF(uint i, uint j, uint v) public {
        ...
        unchecked {
            ...
            if (!(_v.forall_6)) {
                emit __ScribbleUtilsLib__326.AssertionFailed("5: ");
                assert(false);
            }
        }
    }
    ...
    function setG(uint i, uint j, uint v) public {
        ...
        unchecked {
            ...
            if (!(_v.forall_7)) {
                emit __ScribbleUtilsLib__326.AssertionFailed("6: ");
                assert(false);
            }
        }
    }
    ...
    function setH(string memory s, uint8 k, int8 v) public {
        ...
        unchecked {
            ...
            if (!(_v.forall_8)) {
                emit __ScribbleUtilsLib__326.AssertionFailed("7: ");
                assert(false);
            }
        }
    }
    ...
    function setI(string memory s, uint8 k, int8 v) public {
        ...
        unchecked {
            ...
            if (!(_v.forall_9)) {
                emit __ScribbleUtilsLib__326.AssertionFailed("8: ");
                assert(false);
            }
        }
    }
    ...
    function setJ(uint saI, string memory x, uint v) public {
        ...
        unchecked {
            ...
            if (!(_v.forall_10)) {
                emit __ScribbleUtilsLib__326.AssertionFailed("9: ");
                assert(false);
            }
        }
    }
    ...
    function setJ2(uint saI, string memory x, uint v) public {
        ...
        unchecked {
            ...
            if (!(_v.forall_11)) {
                emit __ScribbleUtilsLib__326.AssertionFailed("10: ");
                assert(false);
            }
        }
    }
    ...
    function setK1(uint i, uint v) public {
        ...
        unchecked {
            if (!(_v.old_0)) {
                emit __ScribbleUtilsLib__326.AssertionFailed("11: ");
                assert(false);
            }
        }
    }
