...
contract Foo {
    ...
    function changesArg1(uint x) public {
        ...
        unchecked {
            if (!(_v.old_0 == 0)) {
                ...
                emit __ScribbleUtilsLib__158.AssertionFailed("01043:064:00 4: ");
            }
        }
    }
    ...
    function changesArg2(uint x) public {
        ...
        unchecked {
            if (!(x == 0)) {
                ...
                emit __ScribbleUtilsLib__158.AssertionFailed("01448:064:00 5: ");
            }
        }
    }
    ...
    function changesArr1() public {
        ...
        unchecked {
            if (!(_v.old_1 == 0)) {
                ...
                emit __ScribbleUtilsLib__158.AssertionFailed("01970:064:00 6: ");
            }
        }
    }
    ...
    function changesArr2() public {
        ...
        unchecked {
            if (!(x[0] == 0)) {
                ...
                emit __ScribbleUtilsLib__158.AssertionFailed("02368:064:00 7: ");
            }
        }
    }
    ...
    function newRet() public returns (uint RET) {
        ...
        unchecked {
            if (!(RET == 1)) {
                ...
                emit __ScribbleUtilsLib__158.AssertionFailed("02782:064:00 8: ");
            }
        }
    }
    ...
    function shadowing(uint x) public {
        ...
        unchecked {
            ...
            if (!(_v.let_2)) {
                ...
                emit __ScribbleUtilsLib__158.AssertionFailed("03442:064:00 9: ");
            }
        }
    }
    ...
    function Foo_arr_inline_initializer() internal {
        unchecked {
            if (!(arr[t] == 3)) {
                ...
                emit __ScribbleUtilsLib__158.AssertionFailed("04415:064:00 0: ");
            }
        }
    }
    ...
    function Foo_arr_idx_uint256_uint256_assign(uint256 ARG0, uint256 ARG1) internal returns (uint256 RET0) {
        ...
        unchecked {
            if (!(arr[t] == 3)) {
                emit __ScribbleUtilsLib__158.AssertionFailedData(0, abi.encode(arr, t));
                emit __ScribbleUtilsLib__158.AssertionFailed("04833:064:00 0: ");
            }
        }
    }
    ...
    function Foo_arr1_idx_uint256_uint256_assign(uint256 ARG2, uint256 ARG3) internal returns (uint256 RET1) {
        ...
        unchecked {
            if (!(_v.old_2 == 3)) {
                ...
                emit __ScribbleUtilsLib__158.AssertionFailed("05374:064:00 1: ");
            }
        }
    }
    ...
    function Foo_m_idx_ptr_string_memory_ptr_arr_uint256_1_memory_assign(string memory ARG4, uint256[1] memory ARG5) internal returns (uint256[] storage RET2) {
        ...
        unchecked {
            if (!(m[ARG4].length > 1)) {
                ...
                emit __ScribbleUtilsLib__158.AssertionFailed("05844:064:00 2: ");
            }
        }
    }
    ...
    function Foo_m_idx_ptr_string_memory_ptr_arr_uint8_3_memory_assign(string memory ARG6, uint8[3] memory ARG7) internal returns (uint256[] storage RET3) {
        ...
        unchecked {
            if (!(m[ARG6].length > 1)) {
                ...
                emit __ScribbleUtilsLib__158.AssertionFailed("06310:064:00 2: ");
            }
        }
    }
    ...
    function Foo_m_idx_ptr_string_memory_idx_uint256_uint256_assign(string memory ARG8, uint256 ARG9, uint256 ARG10) internal returns (uint256 RET4) {
        ...
        unchecked {
            if (!(m[ARG8][ARG9] > 0)) {
                ...
                emit __ScribbleUtilsLib__158.AssertionFailed("06788:064:00 3: ");
            }
        }
    }
}
