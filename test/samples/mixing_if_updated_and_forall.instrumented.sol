...
library address_to_string_to_uint256_S_79 {
    struct S {
...
contract Foo is __scribble_ReentrancyUtils {
    ...
    address_to_string_to_uint256_S_79.S internal m1;
    ...
    function assign_m1(address a, string memory s, uint v) public returns (uint RET_0) {
        ...
        unchecked {
            ...
            for (_v.i0 = 1; _v.i0 < m1.keys.length; _v.i0++) {
                _v.a0 = m1.keys[_v.i0];
                _v.forall_1 = true;
                for (_v.i1 = 1; _v.i1 < address_to_string_to_uint256_S_79.get(m1, _v.a0).keys.length; _v.i1++) {
                    _v.s0 = address_to_string_to_uint256_S_79.get(m1, _v.a0).keys[_v.i1];
                    _v.forall_1 = string_to_uint256.get(address_to_string_to_uint256_S_79.get(m1, _v.a0), _v.s0) > 1;
    ...
    function _original_Foo_assign_m1(address a, string memory s, uint v) private returns (uint) {
        ...
        return string_to_uint256.get(address_to_string_to_uint256_S_79.get(m1, a), s);
    }
    ...
    function Foo_m1_idx_address_ptr_string_memory_uint256_set(address ARG2, string memory ARG3, uint256 ARG4) internal {
        string_to_uint256.set(address_to_string_to_uint256_S_79.get_lhs(m1, ARG2), ARG3, ARG4);
        unchecked {
            if (!(string_to_uint256.get(address_to_string_to_uint256_S_79.get(m1, address(0x0)), "abcd") < 5)) {
