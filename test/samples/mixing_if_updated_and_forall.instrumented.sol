...
contract Foo {
    ...
    function assign_m1(address a, string memory s, uint v) public returns (uint RET_0) {
        ...
        unchecked {
            ...
            if (!(_v.forall_0)) {
                emit __ScribbleUtilsLib__62.AssertionFailed("01574:063:00 5: ");
                assert(false);
            }
        }
    }
    ...
    function Foo_m_uint256_uint256_set(uint256 ARG0, uint256 ARG1) internal {
        ...
        unchecked {
            ...
            if (!(_v.forall_2)) {
                emit __ScribbleUtilsLib__62.AssertionFailed("02451:063:00 0: ");
                assert(false);
            }
        }
    }
    ...
    function Foo_m1_idx_address_ptr_string_memory_uint256_set(address ARG2, string memory ARG3, uint256 ARG4) internal {
        ...
        unchecked {
            if (!(string_to_uint256_62.get(address_to_string_to_uint256_62_S_64_62.get(m1, address(0x0)), "abcd") < 5)) {
                emit __ScribbleUtilsLib__62.AssertionFailed("02962:063:00 1: ");
                assert(false);
            }
            if (!(ARG2 == address(0x0))) {
                emit __ScribbleUtilsLib__62.AssertionFailed("03131:063:00 4: ");
                assert(false);
            }
        }
    }
