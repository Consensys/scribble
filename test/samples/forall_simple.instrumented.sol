...
contract ForallSimple {
    ...
    function test1(uint[] memory a, uint x) public {
        ...
        unchecked {
            ...
            if (!(_v.forall_1)) {
                emit __ScribbleUtilsLib__106.AssertionFailed("02683:064:00 1: ");
                assert(false);
            }
        }
    ...
    function test2(uint[] memory a, uint x) public {
        ...
        unchecked {
            ...
            if (!(_v.forall_2)) {
                emit __ScribbleUtilsLib__106.AssertionFailed("03632:064:00 2: ");
                assert(false);
            }
        }
        if (_v.__scribble_check_invs_at_end) __scribble_check_state_invariants();
    ...
    function test3(uint[] memory a, uint x) public {
        ...
        unchecked {
            if (!(_v.old_1)) {
                emit __ScribbleUtilsLib__106.AssertionFailed("04736:064:00 3: ");
                assert(false);
            }
        }
        if (_v.__scribble_check_invs_at_end) __scribble_check_state_invariants();
    ...
    function test4(uint[][] memory a, uint x) public {
        ...
        unchecked {
            ...
            if (!(_v.forall_4)) {
                emit __ScribbleUtilsLib__106.AssertionFailed("05930:064:00 4: ");
                assert(false);
            }
        }
        if (_v.__scribble_check_invs_at_end) __scribble_check_state_invariants();
    ...
    function test5() public {
        ...
        unchecked {
            ...
            if (!(_v.forall_6)) {
                emit __ScribbleUtilsLib__106.AssertionFailed("06820:064:00 5: ");
                assert(false);
            }
        }
        if (_v.__scribble_check_invs_at_end) __scribble_check_state_invariants();
    ...
    function test6() public {
        ...
        unchecked {
            ...
            if (!(_v.forall_7)) {
                emit __ScribbleUtilsLib__106.AssertionFailed("07646:064:00 6: ");
                assert(false);
            }
        }
        if (_v.__scribble_check_invs_at_end) __scribble_check_state_invariants();
    ...
    function test7() public {
        ...
        unchecked {
            ...
            if (!(_v.forall_8)) {
                emit __ScribbleUtilsLib__106.AssertionFailed("08472:064:00 7: ");
                assert(false);
            }
        }
        if (_v.__scribble_check_invs_at_end) __scribble_check_state_invariants();
    ...
    function test11() public {
        ...
        unchecked {
            ...
            if (!(_v.forall_9)) {
                emit __ScribbleUtilsLib__106.AssertionFailed("09296:064:00 8: ");
                assert(false);
            }
        }
        if (_v.__scribble_check_invs_at_end) __scribble_check_state_invariants();
    ...
    function test12() public {
        ...
        unchecked {
            ...
            if (!(_v.let_4)) {
                emit __ScribbleUtilsLib__106.AssertionFailed("10242:064:00 9: ");
                assert(false);
            }
        }
        if (_v.__scribble_check_invs_at_end) __scribble_check_state_invariants();
    ...
    function __scribble_ForallSimple_check_state_invariants_internal() internal {
        ...
        unchecked {
            ...
            if (!(_v.forall_0)) {
                emit __ScribbleUtilsLib__106.AssertionFailed("11015:064:00 0: ");
                assert(false);
            }
        }
    }
