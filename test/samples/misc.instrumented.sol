...
contract AddrChecker {
    function checkAddr(address addr) external {
        ...
        if (!(addr != address(0xAaaaAaAAaaaAAaAAaAaaaaAAAAAaAaaaAaAaaAA0))) {
            emit __ScribbleUtilsLib__268.AssertionFailed("00355:066:00 0: P1");
            assert(false);
        }
    }
...
contract MapIdx {
    ...
    function main(string memory arg) public {
        ...
        if (!(a[arg] == 0)) {
            emit __ScribbleUtilsLib__268.AssertionFailed("00805:065:00 1: F");
            assert(false);
        }
    }
...
contract MemoryCast {
    ...
    function entry() external {
        ...
        if (!(_isEvenLen(_nums))) {
            emit __ScribbleUtilsLib__268.AssertionFailed("01155:066:00 2: P1");
            assert(false);
        }
    }
...
contract OldInOld {
    ...
    function moo() public {
        ...
        _v.let_2 = _v.let_1;
        if (!(_v.let_2)) {
            emit __ScribbleUtilsLib__268.AssertionFailed("02019:064:00 3: ");
            assert(false);
        }
    }
...
contract OldInOld2 {
    ...
    function balanceOf() public returns (uint RET_0) {
        ...
        if (!(_v.let_3)) {
            emit __ScribbleUtilsLib__268.AssertionFailed("02599:064:00 4: ");
            assert(false);
        }
    }
...
contract OldTuple {
    ...
    function main(uint k) public {
        ...
        if (!(_v.let_4)) {
            emit __ScribbleUtilsLib__268.AssertionFailed("03263:064:00 5: ");
            assert(false);
        }
    }
...
contract Result {
    ...
    function a() public returns (uint RET_0) {
        ...
        if (!(RET_0 == 1)) {
            emit __ScribbleUtilsLib__268.AssertionFailed("03765:064:00 6: ");
            assert(false);
        }
    }
    ...
    function b() public returns (uint x) {
        ...
        _v.let_5 = _v.t2 == x;
        if (!(x == x)) {
            emit __ScribbleUtilsLib__268.AssertionFailed("04148:064:00 7: ");
            assert(false);
        }
        if (!(_v.let_5)) {
            emit __ScribbleUtilsLib__268.AssertionFailed("04290:064:00 8: ");
            assert(false);
        }
    }
    ...
    function d() public returns (uint RET_0, uint t) {
        ...
        if (!(_v.let_6)) {
            emit __ScribbleUtilsLib__268.AssertionFailed("04749:064:00 9: ");
            assert(false);
        }
    }
...
contract UsingForRefType {
    ...
    function main(string memory mS) public {
        ...
        if (!(sS.len() == mS.len())) {
            emit __ScribbleUtilsLib__268.AssertionFailed("05297:066:00 10: F");
            assert(false);
        }
    }
...
contract ExternalCall {
    function process(bytes calldata _bytes) external returns (bool result) {
        ...
        if (!(this.checkBytes(_bytes) == result)) {
            emit __ScribbleUtilsLib__268.AssertionFailed("05707:075:00 11: wrong byte");
            assert(false);
        }
    }
...
contract CallinInstrumentedFun {
    ...
    function getX() public returns (uint res) {
        ...
        if (!(res > 0)) {
            emit __ScribbleUtilsLib__268.AssertionFailed("06385:065:00 12: ");
            assert(false);
        }
    }
    ...
    function inc(uint x) public returns (uint res) {
        ...
        if (!(res == (x + _original_CallinInstrumentedFun_getX()))) {
            emit __ScribbleUtilsLib__268.AssertionFailed("06796:065:00 13: ");
            assert(false);
        }
    }
...
contract IndexAccessOnResult {
    function foo() public returns (uint[] memory RET_0) {
        ...
        if (!(RET_0[0] > 1)) {
            emit __ScribbleUtilsLib__268.AssertionFailed("07214:065:00 14: ");
            assert(false);
        }
    }
